...
In this post, we will set up nix and home-manager configuration that can be used in any developement machine.
...
There are numerous articles explaning on how we can achieve this. My setup is particularly inspried by two articles:

* https://drewdevault.com/2019/12/30/dotfiles.html
* https://www.atlassian.com/git/tutorials/dotfiles

In summary, our dotfiles git repository will have following chracterestics:
...
Detailed instructions how how to set up this dotfiles repository will be convered on a different post.
...
<section class="nes-container with-title">
    ...
    <span class="nes-text is-warning">This section is for OSX users only</span>
</section>

While you don't have to, it is good idea to install nix-darwin, if you are using mac machine.
...
isn't enough for my use case. I need to be able to use same flake file on my each dev machines. 
Unfortunately, I have different user names for each  dev machines. 
